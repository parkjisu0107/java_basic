...
import etc.api.collection.list.User;
...
static Random r = new Random();
    ...
    //당첨 등수를 알려주는 메서드
    public static void checkLottoNumber(Set<Integer> win, Set<Integer> n, int bonus) {
        /*
    	...
    	switch(count) {
    	case 3: prize5 += 1; break;
    	case 4: prize4 += 1; break;
    	case 5:
    		if(bonus == 0) {
    			prize2 += 1;
    		}else {
...
//로또 번호 생성 메서드를 호출해서 당첨 번호를 하나 고정시키세요.
    	...
    	int winbonus = createBonusNum(win);
    	...
    	Set<Integer> n = createLotto();
    	int b = createBonusNum(n);
    	System.out.print("당첨 번호: ");
    	for(int nums : n) {
    		System.out.print(nums + " ");
    	}
        ...
        while(true) {
             ...
             */
        	checkLottoNumber(win, n, winbonus);
